defmodule Proj2.Cli do
  alias Proj2.{Gossip, PushSum, Neighborhood, Failure}
  ...
  def parse_args(args) do
    case args do
      [num_actors, topology, algorithm, failures] ->
        {String.to_integer(num_actors), topology, algorithm, failures}
  ...
  def run({num_actors, topology, algorithm, failures}) do
    Failure.start_link(failures)
